...
class TestSliceWidth(unittest.TestCase):
    ...
    rods = [
        Rod(70.26906602941604, 190.52291430040833),
    ...
    def test_rod_distortions(self):
        ...
        (
            ...
            vertical_distortion,
        ) = self.slice_width.get_rod_distortions(horz_dist, vert_dist)
        # print("rod distortion")
        # print(horizontal_distortion, vertical_distortion)
        assert (
            round(horizontal_distortion, 2),
            round(vertical_distortion, 2),
        ) == self.ROD_DIST
    ...
    def test_get_initial_trapezoid_fit_and_coefficients(self):
        ...
        (
            ...
            ramps_baseline_corrected["top"]["profile_corrected_interpolated"],
            slice_thickness,
        )
    ...
    def test_slice_width(self):
        ...
        slice_width_mm = result.get_measurement(name="slice width")[0].value
...
class Test512Matrix(TestSliceWidth):
    ...
    """
    matlab_rods = [
        Rod(134.19422395407386, 376.3297092734241),
    ...
    rods = [
        Rod(134.50715482125025, 376.39901305569873),
