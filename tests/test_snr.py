...
class TestSnr(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_file_3 = pydicom.read_file(str(self.SNR_DATA / 'Philips'/'Philips_IM-0011-0005.dcm'), force=True)
...
class TestSnrPhilips(TestSnr):
    ...
    def setUp(self):
        ...
        self.test_file_3 = pydicom.read_file(str(self.SNR_DATA / 'Siemens' / 'tra_250_2meas_1.IMA'), force=True)
...
class TestSnrThreshold(TestSnr):
    ...
    def setUp(self):
        ...
        self.test_file_3 = pydicom.read_file(str(self.SNR_DATA_2 / 'Siemens' / 'tra_250_2meas_1.IMA'), force=True)
